...
export default function DvtBadge() {
	...
	const dvtStyle = {
		...
		color: '#fff',
		zIndex: 90,
		backgroundColor: 'var(--primary)', // Replace with actual color of --primary
